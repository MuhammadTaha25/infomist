  ...
  return (
    <>
      <div className="w-full min-h-screen overflow-x-hidden">
        <PageHeroVideo
          eyebrow="Proof"
          title="Proof that intelligent systems work in the"
          accent="real world."
          sub="A closer look at the AI systems, automation workflows, platforms and products Infomist has designed, engineered and put into production."
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-14 pb-20 md:pt-16 md:pb-24">
            {/* Proof stats */}
            <Reveal>
